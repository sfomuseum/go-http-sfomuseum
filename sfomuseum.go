...
func DefaultSFOMuseumOptions() *SFOMuseumOptions {
	...
	opts := &SFOMuseumOptions{
		CSS: []string{
			"/css/css_tYMnZJENio3fbqTvIRK7wb8dpGIx2TaK1n--M2StjfQ.purify.css",
			"/css/sfomuseum.org.social.pruned.css",
			"/css/sfomuseum.bootstrap.purify.css",			
			"/css/sfomuseum.common.purify.css",
			"/css/sfomuseum.common.grid.css",
			"/css/sfomuseum.common.media.purify.css",									
/*
			"/css/sfomuseum.sweater.css", // This	is generated by	the 'css' target in the Makefile
...
*/
		...
		JS: []string{
			...
			// "/javascript/jquery.once.min.js",			
			// "/javascript/superfish.min.js",
			"/javascript/sfomuseum.sweater.deps.js", // This is generated by the 'js-deps' target in the Makefile			
			"/javascript/sfomuseum.sweater.js", 	// This is generated by the 'js-sfom' target in the Makefile
		},
	}
